...
router.post('/signup', (req, res) => {
  ...
  const encPw = crypto.pbkdf2Sync(password, salt, 100000, 64, 'sha512').toString('base64');
...
router.post('/signin', (req, res) => {
  ...
  const savedPw = crypto.pbkdf2Sync(password, user.salt, 100000, 64, 'sha512').toString('base64');
  if (savedPw !== user.password) {
